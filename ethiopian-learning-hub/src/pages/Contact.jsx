...
// ✅ FIXED: Imported PageWrapper to lock this view into your global layout transitions
      ...
      <div className="max-w-7xl mx-auto px-4 py-16 grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4 pt-4">
            ...
            {/* ✅ DYNAMIC MAP INSERTION FOR USER GROUNDING */}
            <div className="w-full h-48 rounded-2xl overflow-hidden border border-slate-800/80 shadow-inner bg-slate-950/40 relative">
              <iframe
                title="Ethiopian Learning Hub HQ Map Location"
                src="https://google.com"
                className="w-full h-full border-0 grayscale opacity-75 invert contrast-[90%] brightness-[85%]"
                allowFullScreen=""
                loading="lazy"
              ></iframe>
            </div>
        ...
        <div className="glass-card p-8 rounded-3xl transition duration-300 hover:border-slate-800">
          <form onSubmit={handleMessageSend} className="space-y-5">
            ...
            <div className="flex flex-col space-y-2">
              <label className="text-xs font-bold uppercase tracking-wider text-slate-400">Detailed Message Description</label>
